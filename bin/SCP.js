      ...
      (function(Voronoi) {
      	...
      	function getColor(cell) {
      		var cr = Math.floor((cell * 5) + r),
      			cg = Math.floor((cell * 5) + g),
      			cb = Math.floor((cell * 5) + b);
          ...
          context.save();
          context.beginPath();
          context.arc(canvasWidth / 2, canvasHeight / 2, canvasWidth / 2, 0, Math.PI * 2, true);
          context.closePath();
          context.clip();
      	...
      	Voronoi.init = function(width, height) {
      		...
      		canvasWidth = canvas.width = width || 100;
      		canvasHeight = canvas.height = height || 100;

      		var i = totalVertices = Math.round(canvasWidth * canvasHeight / 600);
      		while (i--) {
