...
if 0
plot( slopes(diff>Thresh,1), slopes(diff>Thresh,2), 'mo',...
    'markerface', 'm',...
    'markeredge', 'm',...
    'markersize', 6 )
end
...
for i = 1:length(slopes)
    ud.url = sprintf( '%s%s%s', sgd1, Common_Annot{i,2}, sgd2 ) ;
...
for i=INDS,  k=k+1; 
           ...
           plot( all_slopes(i,1), all_slopes(i,2), MarkerType, 'markerface', Color, 'markeredge', Color, 'markersize', Size ), hold on
