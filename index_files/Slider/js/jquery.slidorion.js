        ...
        slidorion: function(options) {
            ...
            return this.each(function() {
                ...
                var $slider      = $('.slider', obj),
                    ...
                    $linkContent = $accordion.find('.Slidercontent');
                ...
                var sectionClicked = function() {
                    if (!active) {
                        ...
                        $linkHeaders.removeClass('active').next('.Slidercontent').slideUp();
                        $linkHeaders.eq(section).addClass('active').next('.Slidercontent').slideDown();
